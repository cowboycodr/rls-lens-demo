...
with check ((select auth.uid()) = user_id);`;
  ...
  function checkoutUrl() {
    return withTrackingParams(APP_CONFIG.checkoutUrl || "./buy.html");
  }
  ...
  function analyzeRls(input) {
    ...
    const warnings = buildStaticWarnings(input, rlsEnabled, matchingPolicies, policies, matchingGrants, matchingIndexes).concat(
